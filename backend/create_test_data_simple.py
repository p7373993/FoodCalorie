...
print(f"Deleted {meal_deleted} meals, {weight_deleted} weight records")

# Korean foods with calories (integers only)
korean_foods = [
...
for i in range(30):
    ...
    if i == 29:  # Today
        ...
        meal_count += 1
        print(f"Today breakfast: {food_name} ({calories}kcal)")
    else:
...
# Create 7 days weight data (integers only)
